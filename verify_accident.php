    ...
    *{
        ...
        font-family: sans-serif;
			...
			* {
			...
			.cont{
				...
				color: #f1f1f1;
				height:300px; margin-top: 25px;font-family: sans-serif;
			}
	...
	<body>
		...
		<ul>
      	...
      	<div class="cont"><br>
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Verify Accident</h2>


		<div class="container">
			<form action="verify_accident_action.php" method = "post">



				<div class="row">
					<div class="col-25">
						<label for="lname">ACCIDENT ID</label>
					</div>
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="verifyaccidentid" placeholder="Accident Id...">
					</div>
				</div>
