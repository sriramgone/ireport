<html>
  ...
  <div class="bg">
		...
		<ul>
			...
			<br></br><h2 style="font-style:italic; font-family: sans-serif;color: #fff;font-size:30px;padding-left:30px;">Unverified Accidents</h2>
...
<?php
		...
		$sql = "SELECT accidentid,victim_name,reporter_name,date,time FROM accident WHERE verifyid is NULL
