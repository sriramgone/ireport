<html>
	...
	<body>
		...
		<ul>
			<li id="titlehead" style="text-decoration-color:White;"><p id="title" style="font-size:30px;font-family:sans-serif;";>iREPORT</p></li>
		...
		<div class="container">
			<form action="admin_login_action.php" method = "post">
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required  name="adminname" placeholder="Your Id..">
					</div>
				</div>
