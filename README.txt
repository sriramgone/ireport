   ...
   It stores the details of accidents reported by the users , analyze  the data and fetches details of any reported accident.
   ...
   After logging in you can see the dashboard which contains many functionalities
            ...
            *  He can add, remove, delete, verify and unverify users.
  ...
  Just import report sql file and you are good to go.
   Further more details can be known by checking the website iREPORT.

   Now you are ready to visit the website.
