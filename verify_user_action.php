...
<?php
		...
		$verifyid = filter_input(INPUT_POST,'verifyid');
 ...
 if($conn->query($sql) === TRUE) {
	...
	echo "<div id='card'><br></br><p>USER SUCCESFULLY VERIFIED</p><form action='admin_home.php' method='post'><button type='submit' id='done'>Done</button><br></br></form></div>";
