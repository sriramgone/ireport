<html>
    ...
    *{margin: 0;}
	...
	<br></br><h2 style="font-style:italic; font-family: sans-serif;color: #fff;font-size:30px;padding-left:30px;">Verified Accidents</h2>
<?php
		error_reporting(0);
		...
		$sql = "SELECT accidentid,victim_name,reporter_name,date,time FROM accident WHERE verifyid=1
    ...
    if ($result->num_rows > 0) {
		...
		if ($result->num_rows > 0) {
         ...
         echo "<td>".$row['reporter_name'] . "</td>";
			...
			echo "<div id='card'><br></br><p>NO ACCIDENT VERIFIED.</p><form action='admin_home.php' method='post'><button type='submit' id='done'>Done</button><br></br></form></div>";
		}
