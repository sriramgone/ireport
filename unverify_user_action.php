...
<?php
		...
		$unverifyid = filter_input(INPUT_GET,'unverifyid');


    $sql = " UPDATE user
    SET useradminid = NULL
    WHERE user_id = 	$unverifyid;";
 ...
 if($conn->query($sql) === TRUE) {
	...
	echo "<div id='card'><br></br><p>USER SUCCESFULLY UNVERIFIED</p><form action='admin_home.php' method='post'><button type='submit' id='done'>Done</button><br></br></form></div>";
