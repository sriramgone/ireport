...
background-image: linear-gradient(160deg, #19555e 0%, #409ec7 20%, #47dcd2 37%, #1c7b83 61%, #1f627f 80%, #72d7e6 100%);
	...
	<body>
  	...
  	<div class="cont">
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Unverify User</h2>

	<br><br>

		<div class="container">
			<form action="unverify_user_action.php" method = "get">
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="unverifyid" placeholder="User Id...">
					</div>
				</div>
