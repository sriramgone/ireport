<html>
     ...
     font-family: sans-serif;
			...
			* {
			...
			.cont{
				...
				color: #f1f1f1;
				height:400px;padding-top: 25px; font-family: sans-serif;
			}
	...
	<body>
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Verify User</h2>



		<div class="container">
			<form action="verify_user_action.php" method = "post">
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="verifyid" placeholder="User Id...">
					</div>
				</div>
