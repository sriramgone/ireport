...
<?php
		...
		$sql = "SELECT * FROM user WHERE user_name='$username' AND user_password='$userpass'";
		...
		if ($result->num_rows > 0) {
			...
			echo "<div id='card'><br></br><p>Invalid Id or Password!!!</p><p>Try again with valid Id and Password</p><form action='user_login.php' method='get'><button type='submit' id='done'>Done</button><br></br></form></div>";
