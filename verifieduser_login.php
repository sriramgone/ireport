<html>
	     ...
	     background-image: linear-gradient(160deg, #19555e 0%, #409ec7 20%, #47dcd2 37%, #1c7b83 61%, #1f627f 80%, #72d7e6 100%);
			...
			* {
			...
			.cont{
				...
				color: #f1f1f1;padding-top: 25px; font-family: sans-serif;
        height: 400px;
			}
	...
	<body>
		...
		<div class="cont">
			<h2 style="font-style:italic; font-family: sans-serif;color: #fff;font-size:30px;padding-left:30px;">Verified User Login</h2>


		<div class="container">
			<form action="verifieduser_login_action.php" method = "post">
				<div class="row">
					<div class="col-25">
