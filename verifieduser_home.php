...
<div class="cont">
     <br><br>
		<h2 style="font-style:italic; font-size:35px;padding-left:30px;">Verified User Dashboard</h2><br><br>
		<div class="grid-container">


			<div ><button type="button" class="btn" onclick="location.href='vdisplay_accident.php'"style="background-color:transparent;color:white;">REPORTED ACCIDENTS</button></div>
			...
			<div ><button type="button" class="btn" onclick="location.href='vsearchby_hospitalname.php'"style="background-color:transparent;color:white;">SEARCH ACCIDENT BY HOSPITAL</button></div>

			<div ><button type="button" class="btn" onclick="location.href='vsearchby_victimname.php'"style="background-color:transparent;color:white;">SEARCH ACCIDENT BY VICTIM </button></div>
		</div>
		</div>
    <br><br>
		</div>
