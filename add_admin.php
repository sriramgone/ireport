	...
	<div class="cont"><br>
		...
		<div class="container">
			<form action="add_admin_action.php" method = "post">
				...
				<div class="row">
					<div class="col-25">
						<label for="lname">ADMIN USERNAME</label>
					</div>
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="adminname" placeholder="ENTER ADMIN USERNAME...">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="password" pattern=".{1,}" required name="adminpass" placeholder="password...">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="adminaddress" placeholder="address...">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="adminnumber" placeholder=" phone no...">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="email" pattern=".{1,}" required name="adminemail" placeholder="email address...">
					</div>
				</div>
