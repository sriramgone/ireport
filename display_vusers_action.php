...
<div class="bg">
		...
		<ul>
			...
			<br></br><h2 style="font-style:italic; font-family: sans-serif;color: #fff;font-size:30px;padding-left:30px;">Verified Users</h2>
...
<?php
		...
		$sql = "SELECT user_id,user_name,user_email,user_phone FROM user WHERE useradminid=2";
        ...
        echo "<tr>";
	      ...
	      echo "<td>" . $row['user_name'] . "</td>";
			...
			echo "<div id='card'><br></br><p>NO ONE VERIFIED.</p><form action='admin_home.php' method='post'><button type='submit' id='done'>Done</button><br></br></form></div>";
